...
namespace برمجة_متقدمة_2
{
    public partial class xmlfile : System.Web.UI.Page
    {
        ...
        protected void View()
        {
             ...
             DS.ReadXml(@"D:\XML-master\students.xml");
        ...
        {
              XDocument xDocument = XDocument.Load(@"D:\XML-master\students.xml");
        ...
        string conn= @"Data Source=DESKTOP-U91N0A8;Initial Catalog=advanced2;Integrated Security=True";
        protected void Button1_Click(object sender, EventArgs e)
        {
            /* SqlConnection connection = new SqlConnection(conn);
             ...
             foreach (GridViewRow gr in GridView1.Rows)
             {
                 SqlCommand command = new SqlCommand("insert into Student(Id,Name,Year,Age) values(@ID,@Name,@Year,@Age)", connection);
             ...
             connection.Close();*/
            Response.Redirect("databasefile.aspx");
        }
